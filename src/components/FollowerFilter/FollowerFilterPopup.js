...
import css from './FollowerFilterPopup.css';

const KEY_CODE_ESCAPE = 27;

class FollowerFilterPopup extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <FollowerFilterForm
          id={id}
          initialValues={hasInitialValues ? initialValues : { minFollower: min, maxFollower: max }}
...
FollowerFilterPopup.defaultProps = {
  rootClassName: null,
  className: null,
  initialValues: null,
...
export default injectIntl(FollowerFilterPopup);
